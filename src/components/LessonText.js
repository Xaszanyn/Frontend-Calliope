export default function LessonText() {
  return (
    <section id="lessonText" className="content">
      <h4>Lesson Text Heading</h4>
      <h5>Lesson Text Subheading</h5>
      <p>This is paragraph.</p>
      <hr />
      <p>
        Integer vestibulum convallis egestas. Curabitur scelerisque gravida
        ...
        congue lectus eget nunc faucibus accumsan. Ut venenatis sagittis
        maximus. Fusce eleifend sed mauris sed iaculis. Cras eu accumsan metus.
      </p>
      <h5>Lesson Text Subheading</h5>
      <ul>
        <li>List Item</li>
